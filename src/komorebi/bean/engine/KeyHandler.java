...
public class KeyHandler {
  ...
  private static int[] timer = new int[Keyboard.KEYBOARD_SIZE+3];
  ...
  public static boolean keyDownStaggered(Key k, int interval)
  {
    return isKeyDown[k.getGLKey()] && (timer[k.getGLKey()]%interval==0 ||
        !wasKeyDown[k.getGLKey()]);
  }
